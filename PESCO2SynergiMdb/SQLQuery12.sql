...
(SectionId,FeederId,17280920310,1020720034,SectionPhases, Description, PhaseConductorId,
NeutralConductorId, PhaseToPhaseSpacing_MUL, PhaseToNeutralSpacing_MUL,AveHeightAboveGround_MUL,
PercentDistLoadConstImpedance, PercentDistLoadConstCurrent, PercentSpotLoadConstImpedance,
PercentSpotLoadConstCurrent, SectionLength_MUL, PercentLoadGrowthRate,MappingLink,LoadConnectionPhaseGnd,
UseEquivSpacing, IdenticalPhaseConductors, PhaseConductor2Id, PhaseConductor3Id, PositionCode,
ConfigurationId, IsContingency,UseSectAmpRating, AmpRating, DistLoadCustZone,SpotLoadCustZone,
UseDistCustZone, UseSpotCustZone, UseCustClassDistLoadIzpq, UseCustClassSpotLoadIzpq,
ExposureZone,MitiZone, GrowthZone, FromElbowOrBayStatus,ToElbowOrBayStatus, ElbowOrBayAmpRating,
DuctBankId,DuctBankInst,DuctBankCircuit,UseDuctBankAmpRating,UseDuctBankConfiguration,
SpotLoadIsOff, EnergizeYear, RetireYear, LoadCategory,NeutIsGrounded, HideMapResults,Note_,
LocationLink, AMSLink, Monitor, ExpFactPermFail, ExpFactTempFail, ExpFactRepair, CostZone
